...
```sh
git clone https://github.com/ivenkatraj/PublicLeech.git
cd PublicLeech
...
* `API_HASH`: Get these two values from [my.telegram.org/apps](https://my.telegram.org/apps).
  * N.B.: if Telegram is blocked by your ISP, try our [Telegram bot](https://telegram.dog/Miss_Sonabot) to get the IDs.
